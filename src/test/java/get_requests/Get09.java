...
public class Get09 extends HerOkuAppBaseUrl {
     /*
      Given
          https://restful-booker.herokuapp.com/booking/798 //798'i orneklerdeki data durumuna gore degistiriyoruz.
      When
...
//        assertEquals(((Map)expectedData.get("bookingdates")).get("checkout") , ((Map)actualData.get("bookingdates")).get("checkout"));
    ...
    public void get09b() {
        ...
        //Set the expected data
        Map<String, String> bookingdatesMap = new HerOkuAppTestData().bookingdatesMapMethod("2018-01-01","2019-01-01");//Önce inner map oluşturulur

        Map<String, Object> expectedData =
                new HerOkuAppTestData().expectedDataMapMethod("John","Smith",111,true, bookingdatesMap,"Breakfast" );
        System.out.println("expectedData = " + expectedData);
