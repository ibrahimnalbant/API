...
public class C01_PostRequest extends HerOkuAppBaseUrl {
    ...
    public void post01() {
        ...
        //Post request ile oluşturulan bookingid değerine başka işlemlerde kullanılmak üzere diğer classlardan
            // ulaşılabilmesi için static bir container içerisine atama yapıyoruz.
